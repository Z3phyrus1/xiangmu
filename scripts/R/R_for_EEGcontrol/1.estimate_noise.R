...
d <- read.table("D:/xiangmu/data/behavior_for_behavior/data.csv",header=T,sep=",")# D:/xiangmu/data/behavior/idsess/data.csv #D:/xiangmu/data/behavior/idsess/data.csv
...
# ------------------------------------------------------------------ #
# now convert the stimuli in units of internal noise
d <- read.table("D:/xiangmu/data/behavior_for_behavior/data.csv",header=T,sep=",")#D:/xiangmu/data/behavior/idsess/data.csv
d$s <- NA
d$sign_s <- NA
for(i in unique(d$id)){
