...
for(i in unique(d$id)){
  ...
  write.table(d_sall, file="D:/xiangmu/data/behavior_for_behavior/sampling_sim.txt",row.names=F)
}
cat("\n\n...done!")

d_sall <- read.table("D:/xiangmu/data/behavior_for_behavior/sampling_sim.txt", header=T)
str(d_sall)
...
pdf(paste("D:/xiangmu/fig/behavior_for_behavior/1",model_plot,"_r2.pdf",sep=""),width=3.3,height=2.2)
