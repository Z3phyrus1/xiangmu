...
d <- read.table("D:/xiangmu/data/behavior_for_behavior/data.csv",header=T,sep=",")# D:/xiangmu/data/behavior_for_behavior/idsess/data.csv #D:/xiangmu/data/behavior_for_behavior/idsess/data.csv
...
for(i in unique(d$id)){
  ...
  write.table(d_noise, file="D:/xiangmu/data/behavior_for_behavior/noise_estimates.txt")#D:/xiangmu/data/behavior_for_behavior/idsess/noise_estimates.txt
}
...
# ------------------------------------------------------------------ #
# now convert the stimuli in units of internal noise
d <- read.table("D:/xiangmu/data/behavior_for_behavior/data.csv",header=T,sep=",")#D:/xiangmu/data/behavior_for_behavior/idsess/data.csv
d$s <- NA
d$sign_s <- NA
for(i in unique(d$id)){
...
write.table(d, file="D:/xiangmu/data/behavior_for_behavior/data_nu.txt", quote=F, row.names=F, sep=";")## ------------------------------------------------------------------ #D:/xiangmu/data/behavior_for_behavior/idsess/data_nu.txt
