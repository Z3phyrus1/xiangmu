...
source("D:/xiangmu/scripts/R/R/additional_optimal_policy_d2.R")
source("D:/xiangmu/scripts/R/R_for_EEGdual/simulate_sampling_model.R")
library(viridis)
...
pdf(file="D:/xiangmu/figures/behavior_for_behavior/obsdata_smooth_2.pdf",width=2.3*scale_factor,height=1.6*scale_factor)
