...
pdf(file="D:/xiangmu/figures/behavior_for_behavior/obsdata_raw_p.pdf",width=2.3,height=1.6)
...
pdf(file="D:/xiangmu/figuresures/behavior_for_behavior/obsdata_smooth_2.pdf",width=2.3*scale_factor,height=1.6*scale_factor)
...
pdf(file="D:/xiangmu/figures/behavior_for_behavior/opti_p.pdf",width=2.3*scale_factor,height=1.6*scale_factor)
...
pdf(file="D:/xiangmu/figures/behavior_for_behavior/sliced_2D_p.pdf",width=1.1*scale_factor,height=1.7*scale_factor)
...
pdf(file="D:/xiangmu/figures/behavior_for_behavior/sliced_2D_p_h.pdf",width=1.8*scale_factor,height=1.3*scale_factor)
#+geom_line(aes(color=y),size=1)
ggplot(d_slice,aes(x=x,y=y,group=plot_group,color=group_i))+geom_line(size=1)+nice_theme+facet_grid(.~s1)+scale_color_manual(values=c("black",bayes_col),name="")+coord_cartesian(xlim=c(0,2.4))+theme(legend.justification = c(1, 0), legend.position = c(1, 0))+labs(x=expression(paste("|",s[2],"| [",sigma,"]")),y="p(correct)")+theme(legend.background = element_rect(fill = "transparent"))+scale_x_continuous(breaks=c(0,1,2))
dev.off()
...
# 
# pdf(file="./figures/sub2_median.pdf",width=2.3,height=1.6)
...
# dev.off()
# 
# pdf(file="./figures/sub1_median.pdf",width=2.3,height=1.6)
...
# dev.off()
# 
# pdf(file="./figures/meta_noise_median.pdf",width=2.3,height=1.6)
